            ...
            <div className="row">
              <div className="col-sm-3">
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title text-dark">{keyboard[0].name}</h5>
              ...
              <div className="col-sm-3">
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title text-dark">{mouse[1].name}</h5>
                    <p class="card-text text-dark">
                      {mouse[1].info}
                    </p>
                  </div>
              ...
              <div className="col-sm-3">
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title text-dark">{keyboard[3].name}</h5>
                    <p class="card-text text-dark">
                      {keyboard[3].info}
                    </p>
                  </div>
              ...
              <div className="col-sm-3">
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title text-dark">{mouse[3].name}</h5>
                    <p class="card-text text-dark">
                      {mouse[3].info}
                    </p>
                  </div>
